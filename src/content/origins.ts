...
export const ORIGINS: Origin[] = [
  {
    ...
    startingResources: { energy: 100, alloys: 100, food: 100, influence: 5 },
    startingPops: 5,
  ...
  },
  {
    ...
    allowedSpeciesIds: ["humans", "insectoid"],
    startingResources: { energy: 80, alloys: 60, food: 160, influence: 5 },
    startingPops: 4,
  ...
  },
  {
    ...
    startingResources: { energy: 140, alloys: 100, food: 40, influence: 10 },
    startingPops: 4,
  ...
  },
  {
    ...
    allowedSpeciesIds: ["machine"],
    startingResources: { energy: 120, alloys: 80, food: 20, influence: 3 },
    startingPops: 5,
